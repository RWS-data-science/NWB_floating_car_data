...
rm(vmax_merged);rm(vmax_wkd);rm(vmax_weggeg)
#merge
...
nwb_select$afwijkende_vorm[  (nwb_select$max_afstand_osm  < 1.2*nwb_select$mean_afstand_osm) &   (nwb_select$mean_afstand_osm > 15)    ] = 1
